...
class App extends Component{
  ...
  a = () => {
    contract.methods.getTimeLeft().call( { from: web3.eth.defaultAccount })
    .then(console.log);
  };
    ...
    return (
      <Router>
        <Container>
          <Row>
            <Col md style={ header }>
              <Link to='/' style={{ textDecoration: 'none' }}><h1 align='center' style={ heading }>Crowdfunding App</h1></Link>
            </Col>
          </Row>
          <Row style={{marginTop: '0px', borderBottom: '1px #ccc dotted'}}>
            ...
            <Col style={{margin: '3px', textAlign: 'right'}}>
              <Link to='/newCampaign'><Button variant='outline-dark' size='sm'>Start a New Campaign</Button></Link>
            </Col>
          </Row>
