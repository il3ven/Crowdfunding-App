    ...
    if (event.target.name === "submit") {
      ...
      Campaign.deploy(this.state.deadline, this.state.goal)
        ...
        .on("receipt", function (receipt) {
          console.log(
            "Address of new contract : 12 -> " + receipt.contractAddress
          ...
          <Col>
            <Form.Group controlId="formGroupName">
              ...
              <Form.Control
                ...
                name="name"
                type="text"
                placeholder="How should people refer you ?"
              />
            </Form.Group>
          </Col>
          <Col>
          ...
          <Col>
            <Form.Group controlId="formGroupDeadline">
              ...
              <Form.Control
                ...
                name="deadline"
                type="text"
                placeholder="How long should this campaign run ?"
              />
            </Form.Group>
          </Col>
          <Col>
            <Form.Group controlId="formGroupGoal">
              ...
              <Form.Control
                ...
                name="goal"
                type="text"
                placeholder="How much do you plan to collect ?"
              />
            </Form.Group>
          </Col>
        </Row>
